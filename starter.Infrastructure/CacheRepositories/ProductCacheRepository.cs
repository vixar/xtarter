using starter.Application.Interfaces.CacheRepositories;
using starter.Application.Interfaces.Repositories;
using starter.Domain.Entities.Catalog;
using starter.Infrastructure.CacheKeys;
...
namespace starter.Infrastructure.CacheRepositories
{
